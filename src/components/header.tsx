...
export function Header() {
  ...
  function handleMenuClick() {
    ...
    isHamburgerOpen ? document.body.style.overflow = "auto" : document.body.style.overflow = "hidden"
  }
    ...
    <div className="w-full border-b border-border">
      <header className="max-w-7xl w-full mx-auto py-2 px-4 flex items-center gap-4">
        ...
        <div className={twMerge(
          ...
          isHamburgerOpen && "z-[1] flex flex-col fixed top-0 bottom-0 left-0 right-0 bg-background justify-evenly"
        )}>
